...
document.getElementById("btn").addEventListener("click",function(){
    ...
    switch(select){
        case 0: document.getElementById("output-text").innerText='Gọi '+ name +' là cây xăng vì lúc nào nhìn thấy em anh cũng muốn đổ.'
            break;
        case 1: document.getElementById("output-text").innerText="Hey "+ name +'. Nếu chúng ta cùng đóng Táo Quân, thì anh sẽ là Nam Tào còn em sẽ là Co Dau nhé.'
            break;
